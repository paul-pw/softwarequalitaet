...
Es gibt einige Artikel und Konferenz Papiere~\cite{Pendleton_Garcia-Lebron_Cho_Xu_2016}, die unterschiedliche Ansätze für das definieren von Metriken verfolgen. 

% TODO eine oder mehrere Metriken zu der gewählten Charakteristik vorstellen.
% Hingehen und metriken aus quellen suchen und vorstellen
% Metriken listen, die beliebt sind und mit den Kriterien oben verknüpfen, wie bei der Wartbarkeit!
