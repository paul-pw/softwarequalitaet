...
\begin{itemize}
  ...
  \item \textbf{Percent use of Coding Standards \acs{pcs}}: Misst den Anteil an Coding-Standards für sichere Entwicklung, die verwendet wurden. Sie kann als ein Annährung für \ac{nse} dienen.
